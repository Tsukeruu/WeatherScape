...
- **Major notes: The utils dir holds dependencies and many other things**
  ...
  - Important variables and swww settings live in utils/pyUtils/Dataclasses.py
  - To edit the arguements, it lives in utils/pyUtils/Args.py
  - And finally to edit the custom errors it lives in utils/pyUtils/Exceptions.py
